    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-5 py-8 sm:px-8 sm:py-12">
      ...
      <Tabs defaultValue="incomes">
        <TabsList className="h-10 p-1">
          <TabsTrigger className="px-3 py-1 text-base" value="incomes">Ingresos</TabsTrigger>
          <TabsTrigger className="px-3 py-1 text-base" value="expenses">Gastos</TabsTrigger>
        </TabsList>
            ...
            <div className="flex flex-col gap-5 sm:flex-row sm:items-end">
              <div>
                ...
                <p className="mt-2 max-w-xl text-sm leading-relaxed text-[var(--sea-ink-soft)]">
                  Registrá lo que entra cada mes para mantener tu panorama
