...
import { listAdminCsvRows, getAdminCsvRow, getAdminResultDetails, saveAdminReport, setAdminReportSent } from './admin.functions'
...
vi.mock('./auth.server', () => ({
  loginAdminServer: vi.fn(),
  getAdminSessionServer: vi.fn(),
...
vi.mock('@/features/onboarding/r2.server', () => ({
  signDownload: vi.fn(),
}))
